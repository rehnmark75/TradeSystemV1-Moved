...
export default function ChartPage() {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      // Fetch trades within the visible time range
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100vh", background: "#0f172a", color: "#e2e8f0" }}>
      ...
      <div style={{
        ...
        <a href="/" style={{ color: "#94a3b8", textDecoration: "none", fontWeight: 600, fontSize: "14px" }}>
          Trading Hub
        </a>
        <span style={{ color: "#334155" }}>/</span>
        <span style={{ color: "#f1f5f9", fontWeight: 600, fontSize: "14px" }}>Chart</span>
      ...
      {/* Error */}
      {error && (
        <div style={{ padding: "8px 16px", background: "#450a0a", color: "#fca5a5", fontSize: "13px", flexShrink: 0 }}>
          {error}
        </div>
      )}
      ...
      <div style={{
        ...
        <span><span style={{ color: "#ef4444" }}>▲</span> BUY loss</span>
        <span><span style={{ color: "#ef4444" }}>▼</span> SELL loss</span>
