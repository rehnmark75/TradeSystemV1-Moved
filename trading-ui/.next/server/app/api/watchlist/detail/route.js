"use strict";(()=>{var e={};e.id=2441,e.ids=[2441],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},8403:(e,a,_)=>{_.r(a),_.d(a,{originalPathname:()=>g,patchFetch:()=>h,requestAsyncStorage:()=>u,routeModule:()=>m,serverHooks:()=>w,staticGenerationAsyncStorage:()=>E});var s={};_.r(s),_.d(s,{GET:()=>n,dynamic:()=>o});var t=_(7599),c=_(4294),r=_(4588),i=_(2921),l=_(740);let o="force-dynamic",d=["ema_50_crossover","ema_20_crossover","macd_bullish_cross"];async function n(e){let{searchParams:a}=new URL(e.url),_=a.get("watchlist"),s=a.get("ticker"),t=a.get("date");if(!_||!s)return i.NextResponse.json({error:"watchlist and ticker are required"},{status:400});let c=await l.d.connect();try{if(d.includes(_)){let e=`
        SELECT
          w.ticker,
          i.name,
        ...
        WHERE w.watchlist_name = $1
          ...
          AND w.ticker = $2
        LIMIT 1
      `,a=await c.query(e,[_,s]);return i.NextResponse.json({row:a.rows[0]||null})}let e=`
      SELECT
        w.ticker,
        i.name,
        COALESCE(i.exchange, 'NASDAQ') as exchange,
      ...
      WHERE w.watchlist_name = $1
        ...
        AND w.ticker = $3
      LIMIT 1
    `,a=await c.query(e,[_,t,s]);return i.NextResponse.json({row:a.rows[0]||null})}catch(e){return console.error("watchlist detail error",e),i.NextResponse.json({error:"Failed to load detail",detail:String(e)},{status:500})}finally{c.release()}}let m=new t.AppRouteRouteModule({definition:{kind:c.x.APP_ROUTE,page:"/api/watchlist/detail/route",pathname:"/api/watchlist/detail",filename:"route",bundlePath:"app/api/watchlist/detail/route"},resolvedPagePath:"/home/hr/Projects/TradeSystemV1/trading-ui/app/api/watchlist/detail/route.ts",nextConfigOutput:"standalone",userland:s}),{requestAsyncStorage:u,staticGenerationAsyncStorage:E,serverHooks:w}=m,g="/api/watchlist/detail/route";function h(){return(0,r.patchFetch)({serverHooks:w,staticGenerationAsyncStorage:E})}},740:(e,a,_)=>{_.d(a,{d:()=>t}),function(){var e=Error("Cannot find module 'pg'");throw e.code="MODULE_NOT_FOUND",e}();let s=process.env.STOCKS_DATABASE_URL||"postgresql://postgres:postgres@postgres:5432/stocks",t=Object(function(){var e=Error("Cannot find module 'pg'");throw e.code="MODULE_NOT_FOUND",e}())({connectionString:s,max:10})}};var a=require("../../../../webpack-runtime.js");a.C(e);var _=e=>a(a.s=e),s=a.X(0,[5822,9967],()=>_(8403));module.exports=s})();