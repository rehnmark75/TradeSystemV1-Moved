...
PAIR_TRAILING_CONFIGS = {
    # ==========================================================================
    # v4.0.0: LOWER TRIGGERS - Recalibrated for actual strategy MFE profile
    # Rationale: With swing TP=16-18 pips, old stages at 25/38/50 were past TP
    # and NEVER fired. Only Early BE mattered. Analysis of 273 trades showed:
    # - Median winner MFE: 5-7 pips (triggers at 15+ caught too few winners)
    # - BE-managed trades: +5,383 total. Non-managed: -8,117 total.
    # - Getting more trades into BE state is the #1 profit lever.
    # New approach: Early BE at 10 (majors) / 12 (JPY), Stage 1 just below TP
    # to capture near-TP reversals.
    # ==========================================================================
    ...
    'CS.D.AUDUSD.MINI.IP': {
        ...
        'stage1_trigger_points': 13,            # Just below TP=16
        'stage1_lock_points': 7,
    ...
    'CS.D.USDCAD.MINI.IP': {
        'early_breakeven_trigger_points': 10,
        'early_breakeven_buffer_points': 3,
        'stage1_trigger_points': 14,            # Just below TP=18
    ...
    # GBPJPY - High volatility JPY cross (12 pip early BE)
    'CS.D.GBPJPY.MINI.IP': {
        'early_breakeven_trigger_points': 12,   # v4.0.0: 20→12 (lower for JPY to capture more winners)
        'early_breakeven_buffer_points': 3,
        'stage1_trigger_points': 15,
        'stage1_lock_points': 8,
        'stage2_trigger_points': 28,
        'stage2_lock_points': 16,
        'stage3_trigger_points': 38,
        'stage3_atr_multiplier': 2.0,
        'stage3_min_distance': 8,
        'min_trail_distance': 8,
        'break_even_trigger_points': 14,
        'enable_partial_close': False,
    ...
    # ========== JPY PAIRS (12 pip early BE) ==========
    # v4.0.0: Lowered from 20 to 12. Old triggers at 30/45/60 were past TP=18.
    # Stage 1 set just below TP to catch near-TP reversals.
    'CS.D.USDJPY.MINI.IP': {
        'early_breakeven_trigger_points': 8,    # v4.0.0: 20→8 (TP=14, needs earlier protection)
        'early_breakeven_buffer_points': 2,
        'stage1_trigger_points': 11,            # Just below TP=14
        'stage1_lock_points': 6,
        'stage2_trigger_points': 20,
        'stage2_lock_points': 12,
        'stage3_trigger_points': 28,
        'stage3_atr_multiplier': 2.0,
        'stage3_min_distance': 8,
        'min_trail_distance': 8,
        'break_even_trigger_points': 10,
        'enable_partial_close': False,
        'partial_close_trigger_points': 16,
        'partial_close_size': 0.4,
    },

    'CS.D.EURJPY.MINI.IP': {
        'early_breakeven_trigger_points': 12,   # v4.0.0: 20→12
        'early_breakeven_buffer_points': 3,
        'stage1_trigger_points': 15,            # Just below TP=18
        'stage1_lock_points': 8,
        'stage2_trigger_points': 28,
        'stage2_lock_points': 16,
        'stage3_trigger_points': 38,
    ...
    'CS.D.CADJPY.MINI.IP': {
        'early_breakeven_trigger_points': 12,
        'early_breakeven_buffer_points': 3,
        'stage1_trigger_points': 15,
        'stage1_lock_points': 8,
        'stage2_trigger_points': 28,
