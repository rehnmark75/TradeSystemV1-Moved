...
if __name__ == "__main__":
   ...
   # Step 1: Detect swing pivots using the LuxAlgo-style function
    ...
    top = select_highest_HH_with_time_fallback(swings_df, bar_limit=zone_lookback, max_age_minutes=2160, debug=True)
    bottom = select_lowest_LL_with_time_fallback(swings_df, bar_limit=zone_lookback, max_age_minutes=2160, debug=True)
    if top and bottom:
