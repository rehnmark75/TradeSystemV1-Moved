#!/usr/bin/env python3
"""
Fixed Simple Optimization System Test
Tests core optimization functionality with proper database handling
"""
...
def test_analysis_queries():
    ...
    try:
        ...
        for row in best_params:
            epic, ema_config, win_rate, pf, net_pips = row
            print(f"   {epic}: {ema_config}, WR={win_rate:.1%}, PF={pf:.2f}, Net={net_pips:.1f}")
...
def main():
    ...
    print("🧪 SIMPLE OPTIMIZATION SYSTEM TEST (FIXED)")
    print("=" * 60)
    ...
    if passed == total:
        ...
        print("\n📋 System Ready!")
        print("✅ PostgreSQL optimization tables created")
        print("✅ Parameter grid calculation working")
        print("✅ Optimization run tracking working")
        print("✅ Result storage working")
        print("✅ Analysis queries working")
