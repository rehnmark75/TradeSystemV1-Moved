...
def main():
    ...
    if not args:
        ...
        while i < len(args):
            ...
            elif arg.upper() in ["SMC", "SMC_SIMPLE", "SMC_EMA", "FVG_RETEST", "FVG", "RANGE_FADE", "RF", "XAU_GOLD", "XAU", "GOLD", "MEAN_REVERSION", "MR", "SMC_MOMENTUM", "SWEEP", "IMPULSE_FADE", "IF", "FA_OR_ATR_TRAIL", "FAOR", "FA_OR", "ATR_TRAIL"]:
                strategy_mapping = {
                    "SMC": "SMC_SIMPLE",
