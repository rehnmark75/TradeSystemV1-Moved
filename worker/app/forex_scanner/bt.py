...
def main():
    ...
    if not args:
        ...
        while i < len(args):
            ...
            elif arg.upper() in ["EMA", "MACD", "BB", "SMC", "SMC_STRUCTURE", "SMC_PURE", "MOMENTUM", "ICHIMOKU", "KAMA", "ZEROLAG", "MEANREV", "RANGING", "SCALPING", "VP", "VOLUME_PROFILE", "EMA_DOUBLE", "EDC", "MASTER", "MASTER_PATTERN", "MP", "AMD", "ICT"]:
                strategy_mapping = {
                    "EMA": "EMA",
                    "MACD": "MACD",
