# ============================================================================
# ⛔⛔⛔ DEPRECATED - DO NOT READ THIS FILE FOR CURRENT CONFIG ⛔⛔⛔
# ============================================================================
#
# ████████████████████████████████████████████████████████████████████████████
# ██                                                                        ██
# ██   THIS FILE IS COMPLETELY DEPRECATED AS OF 2026-01-03                  ██
# ██                                                                        ██
# ██   ALL CONFIGURATION IS NOW IN THE DATABASE:                            ██
# ██     • smc_simple_global_config (global settings)                       ██
# ██     • smc_simple_pair_overrides (per-pair settings like ENABLED_PAIRS) ██
# ██                                                                        ██
# ██   THE VALUES IN THIS FILE ARE STALE AND DO NOT REFLECT REALITY         ██
# ██                                                                        ██
# ██   TO VIEW ACTUAL CONFIG:                                               ██
# ██     • Streamlit UI: Scanner Config → SMC Config tab                    ██
# ██     • SQL: SELECT * FROM smc_simple_pair_overrides;                    ██
# ██                                                                        ██
# ██   ENABLED_PAIRS below is OUTDATED - check database for actual pairs!   ██
# ██                                                                        ██
# ████████████████████████████████████████████████████████████████████████████
#
