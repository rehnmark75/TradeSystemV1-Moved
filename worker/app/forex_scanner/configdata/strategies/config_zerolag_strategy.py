...
ZERO_LAG_LENGTH = 70                    # Zero lag EMA length
ZERO_LAG_BAND_MULT = 1.2               # Band multiplier for volatility bands  
ZERO_LAG_MIN_CONFIDENCE = 0.72         # Minimum confidence threshold (CRITICAL)
