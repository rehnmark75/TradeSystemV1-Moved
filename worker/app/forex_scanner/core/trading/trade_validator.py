...
class TradeValidator:
    ...
    def _safe_validate_support_resistance(self, signal: Dict, provided_market_data: Optional[object] = None) -> Tuple[bool, str]:
        ...
        try:
            ...
            # ================================================================
            # v2.44.0: PATH-TO-TARGET as primary S/R gate
            # Instead of hard proximity rejection (which over-filters profitable
            # SELL signals near support in downtrends), we ask: "does the S/R
            # level actually block the trade's profit path?"
            # Proximity-only check is kept as fallback when TP is unavailable.
            # ================================================================
        ...
        try:
            ...
            if entry_price and stop_loss and take_profit:
                ...
                strategy_rr_overrides = {
                    ...
                    'KAMA_V2': 1.45,  # fixed SL=10/TP=15 => 1.50R by design (research baseline); 1.45 gives rounding margin
                }
