...
type WatchlistDetail = WatchlistRow & {
  ...
  claude_conviction: string | null;
  claude_key_strengths: string[] | string | null;
  claude_key_risks: string[] | string | null;
  claude_position_rec: string | null;
...
export default function Page() {
  ...
  const loadDetails = async (ticker: string) => {
  ...
  const runClaudeAnalysis = async (ticker: string) => {
    ...
    if (!res.ok) {
      ...
      setClaudeMessage((prev) => ({ ...prev, [ticker]: message }));
    } else {
      await loadDetails(ticker);
      setClaudeMessage((prev) => ({ ...prev, [ticker]: "Claude analysis updated." }));
    }
    setClaudeLoading((prev) => ({ ...prev, [ticker]: false }));
  };
                        ...
                        <div className="signal-text">
                          <div className="claude-header">
                            ...
                            <button
                              ...
                              disabled={claudeLoading[row.ticker]}
                            >
